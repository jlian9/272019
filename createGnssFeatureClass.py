#File name: createGPSFeatureClass.py
#Author: MASGIS-ASU (Geo Spatial Research & Solutions - https://gis.asu.edu)
#Python Version: 2.7 or 3.5 or greater
#Description : creates a fgdb, in the current working directory, with a point feature class with gps metadata field & domains
#License :
